    ...
    async receiveEvaluationResult(req, res) {
        try {
            ...
            try {
                ...
                `;
                const scoreResult = await client.query(scoreQuery, [submissionAnswer.submission_id]);
                ...
                await client.query(
                    ...
                    [totalScore, submissionAnswer.submission_id]
                );

                await client.query('COMMIT');

                console.log(`Updated evaluation for submission_answer_id ${id}: ai_marks=${ai_marks}, total_score=${totalScore}`);
