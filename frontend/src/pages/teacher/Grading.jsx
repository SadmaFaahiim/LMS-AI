    ...
    <div className="max-w-7xl mx-auto space-y-6">
      ...
      <div className="flex items-center justify-between flex-wrap gap-4">
        <div>
          ...
          <p className="text-sm text-text-secondary mt-1">View and grade student submissions</p>
        </div>
      ...
      {selectedExam && (
        <div className="grid grid-cols-4 gap-4">
          ...
          <div className="bg-bg-secondary border border-bg-tertiary rounded-lg p-4">
            ...
            <p className="text-xs text-text-secondary font-mono uppercase">Pending</p>
          </div>
          <div className="bg-bg-secondary border border-bg-tertiary rounded-lg p-4">
            <p className="text-2xl font-bold text-info">{stats.processing}</p>
            <p className="text-xs text-text-secondary font-mono uppercase">Processing</p>
          </div>
          <div className="bg-bg-secondary border border-bg-tertiary rounded-lg p-4">
      ...
      {!selectedExam && (
        <div className="bg-bg-secondary border border-bg-tertiary rounded-xl p-12 text-center">
          <p className="text-text-secondary">Select an exam to view submissions</p>
        </div>
      )}
            ...
            <div className="overflow-x-auto">
              <table className="w-full">
                <thead className="bg-bg-primary">
                  <tr>
                    <th className="px-6 py-3 text-left text-xs font-mono text-text-secondary uppercase">Student</th>
                    <th className="px-6 py-3 text-left text-xs font-mono text-text-secondary uppercase">Submitted</th>
                    <th className="px-6 py-3 text-left text-xs font-mono text-text-secondary uppercase">MCQ Score</th>
                    <th className="px-6 py-3 text-left text-xs font-mono text-text-secondary uppercase">AI Score</th>
                    <th className="px-6 py-3 text-left text-xs font-mono text-text-secondary uppercase">Total</th>
                    <th className="px-6 py-3 text-left text-xs font-mono text-text-secondary uppercase">Status</th>
                    <th className="px-6 py-3 text-right text-xs font-mono text-text-secondary uppercase">Actions</th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-bg-tertiary">
                  {filteredSubmissions.map((submission) => (
                    ...
                    >
                      ...
                      <td className="px-6 py-4 text-sm text-accent-secondary">
