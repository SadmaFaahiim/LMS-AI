        ...
        <div className="flex gap-2">
          <button
            ...
            className={`px-3 py-1.5 text-xs font-mono rounded transition-colors ${
              filter === 'all' ? 'bg-accent-secondary text-bg-primary' : 'text-text-secondary hover:text-text-primary'
            }`}
          >
            All
          </button>
          <button
            ...
            className={`px-3 py-1.5 text-xs font-mono rounded transition-colors ${
              filter === 'mcq' ? 'bg-info/20 text-info' : 'text-text-secondary hover:text-text-primary'
            }`}
          >
            MCQ
          </button>
          <button
            ...
            className={`px-3 py-1.5 text-xs font-mono rounded transition-colors ${
              filter === 'short' ? 'bg-accent-secondary/20 text-accent-secondary' : 'text-text-secondary hover:text-text-primary'
            }`}
          >
            Short
          </button>
          <button
            ...
            className={`px-3 py-1.5 text-xs font-mono rounded transition-colors ${
              filter === 'broad' ? 'bg-accent-secondary/20 text-accent-secondary' : 'text-text-secondary hover:text-text-primary'
            }`}
          >
            Broad
          </button>
          <button
            ...
            className={`px-3 py-1.5 text-xs font-mono rounded transition-colors ${
              filter === 'creative' ? 'bg-accent-secondary/20 text-accent-secondary' : 'text-text-secondary hover:text-text-primary'
            }`}
          >
            Creative
          </button>
