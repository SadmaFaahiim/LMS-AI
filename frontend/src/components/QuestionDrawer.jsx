...
export default function QuestionDrawer({ isOpen, onClose, question, onSubmit }) {
            ...
            <div>
              <div className="flex items-center gap-2 mb-1">
                <span className={`text-[10px] font-mono uppercase px-2 py-0.5 rounded ${
                  isMCQ ? 'bg-info/20 text-info' : 'bg-accent-secondary/20 text-accent-secondary'
                }`}>
          ...
          {isMCQ ? (
            ...
            <div className="mb-6">
              ...
              <p className="text-xs text-text-tertiary mt-2">
                Your answer will be evaluated by AI. This may take a few moments.
              </p>
            </div>
          )}
